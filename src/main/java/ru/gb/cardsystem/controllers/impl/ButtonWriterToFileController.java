...
public class ButtonWriterToFileController extends JComponentWriterController {
    ...
    private void init() {
        final JButton writeToFile = new JButton("Write to File");
